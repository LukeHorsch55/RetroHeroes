...
{
    public class YouLostScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            var fontSize = Yoster.MeasureString("You Lost");
            ...
            ScreenManager.SpriteBatch.DrawString(Yoster, "You Lost", title, Color.DarkRed); // Change from title to Vector2.Zero
